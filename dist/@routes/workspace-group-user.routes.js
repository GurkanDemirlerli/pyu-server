...
class WorkspaceGroupUserRoutes {
    static configureRoutes(app) {
        const root = "/api/mocks";
        const ctrl = ioc_1.IOC.container.get(workspace_group_user_controller_1.WorkspaceGroupUserController);
        app.route(root + '/')
...
exports.WorkspaceGroupUserRoutes = WorkspaceGroupUserRoutes;
//# sourceMappingURL=workspace-group-user.routes.js.map