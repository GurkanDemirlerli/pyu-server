...
class SubjectDomainRoutes {
    static configureRoutes(app) {
        const root = "/api/mocks";
        const ctrl = ioc_1.IOC.container.get(subject_domain_controller_1.SubjectDomainController);
        app.route(root + '/')
...
exports.SubjectDomainRoutes = SubjectDomainRoutes;
//# sourceMappingURL=subject-domain.routes.js.map