...
class FolderRoleRoutes {
    static configureRoutes(app) {
        const root = "/api/mocks";
        const ctrl = ioc_1.IOC.container.get(folder_role_controller_1.FolderRoleController);
        app.route(root + '/')
...
exports.FolderRoleRoutes = FolderRoleRoutes;
//# sourceMappingURL=folder-role.routes.js.map