...
class WorkScheduleRoutes {
    static configureRoutes(app) {
        const root = "/api/mocks";
        const ctrl = ioc_1.IOC.container.get(work_schedule_controller_1.WorkScheduleController);
        app.route(root + '/')
...
exports.WorkScheduleRoutes = WorkScheduleRoutes;
//# sourceMappingURL=work-schedule.routes.js.map