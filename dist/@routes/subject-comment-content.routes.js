...
class SubjectCommentContentRoutes {
    static configureRoutes(app) {
        const root = "/api/mocks";
        const ctrl = ioc_1.IOC.container.get(subject_comment_content_controller_1.SubjectCommentContentController);
        app.route(root + '/')
...
exports.SubjectCommentContentRoutes = SubjectCommentContentRoutes;
//# sourceMappingURL=subject-comment-content.routes.js.map