...
let CustomFieldRepository = class CustomFieldRepository extends repository_base_1.RepositoryBase {
    constructor() {
        super(custom_field_entity_1.CustomFieldEntity);
    }
};
CustomFieldRepository = __decorate([
