...
let WorkspaceMemberRepository = class WorkspaceMemberRepository extends repository_base_1.RepositoryBase {
    constructor() {
        super(workspace_member_entity_1.WorkspaceMemberEntity);
    }
};
WorkspaceMemberRepository = __decorate([
