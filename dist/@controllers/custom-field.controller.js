...
let CustomFieldController = class CustomFieldController {
    constructor(_customFieldService) {
    ...
    list(req, res, next) {
        this._customFieldService.list({}, req.decoded.id).then((result) => {
            ...
            return error_handler_1.ErrorHandler.handleErrorResponses(error, res, 'list', 'CustomFieldController');
        });
    }
    insert(req, res, next) {
        ...
        this._customFieldService.add(wspDto).then((createdId) => {
            ...
            return error_handler_1.ErrorHandler.handleErrorResponses(error, res, 'insert', 'CustomFieldController');
        });
    }
    find(req, res, next) {
        ...
        this._customFieldService.find(id, req.decoded.id).then((result) => {
            ...
            return error_handler_1.ErrorHandler.handleErrorResponses(error, res, 'find', 'CustomFieldController');
        });
    }
    update(req, res, next) {
        const id = req.params.id;
        ...
        this._customFieldService.update(id, wspDto, req.decoded.id).then((result) => {
            ...
            return error_handler_1.ErrorHandler.handleErrorResponses(error, res, 'update', 'CustomFieldController');
        });
    }
    delete(req, res, next) {
        const id = +req.params.id;
        this._customFieldService.delete(id, req.decoded.id).then(() => {
            ...
            return error_handler_1.ErrorHandler.handleErrorResponses(error, res, 'delete', 'CustomFieldController');
        });
    }
};
CustomFieldController = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(inject_types_1.InjectTypes.Service.CUSTOM_FIELD)),
