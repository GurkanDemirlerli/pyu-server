...
let WorkspaceController = class WorkspaceController {
    ...
    list(req, res, next) {
        this._workspaceService.list({}, req.decoded.id).then((result) => {
            ...
            return error_handler_1.ErrorHandler.handleErrorResponses(error, res, 'list', 'WorkspaceController');
        });
    }
    insert(req, res, next) {
        ...
        this._workspaceService.add(wspDto).then((createdId) => {
            ...
            return error_handler_1.ErrorHandler.handleErrorResponses(error, res, 'insert', 'WorkspaceController');
        });
    }
    find(req, res, next) {
        ...
        this._workspaceService.find(id, req.decoded.id).then((result) => {
            ...
            return error_handler_1.ErrorHandler.handleErrorResponses(error, res, 'find', 'WorkspaceController');
        });
    }
    update(req, res, next) {
        const id = req.params.id;
        ...
        this._workspaceService.update(id, wspDto, req.decoded.id).then((result) => {
            ...
            return error_handler_1.ErrorHandler.handleErrorResponses(error, res, 'update', 'WorkspaceController');
        });
    }
    delete(req, res, next) {
        const id = +req.params.id;
        this._workspaceService.delete(id, req.decoded.id).then(() => {
            ...
            return error_handler_1.ErrorHandler.handleErrorResponses(error, res, 'delete', 'WorkspaceController');
        });
    }
};
WorkspaceController = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(inject_types_1.InjectTypes.Service.WORKSPACE)),
