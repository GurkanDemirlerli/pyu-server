...
let ProjectRepository = class ProjectRepository extends repository_base_1.RepositoryBase {
    ...
    findForDetails(id) {
        let query = typeorm_1.getManager().createQueryBuilder(project_entity_1.ProjectEntity, "project").select(["project.id", "project.title", "project.description", "project.parentId", "project.statusId", "project.prefix"])
...
class CompanyRoutes {
    static configureRoutes(app) {
        ...
        app.route(root + '/:id/statusTemplates')
            .get(_middlewares_2.authorize, (req, res, next) => ctrl.statusTemplates(req, res, next));
