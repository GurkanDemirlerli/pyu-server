...
let WorkspaceUserService = class WorkspaceUserService {
    constructor(_workspaceUserRepository) {
...
WorkspaceUserService = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(ioc_1.InjectTypes.Repository.WORKSPACE_USER)),
